namespace ThMEPEngineCore.Service.Hvac
{
    public class ThHvacCommon
    {
        ...
        public const string BLOCK_DYNAMIC_PROPERTY_BASE_POINT_X = "设备基点 X";
        public const string BLOCK_DYNAMIC_PROPERTY_BASE_POINT_Y = "设备基点 Y";
        ...
        public const string BLOCK_DYNAMIC_PROPERTY_ANNOTATION_BASE_POINT_X = "标注基点 X";
        public const string BLOCK_DYNAMIC_PROPERTY_ANNOTATION_BASE_POINT_Y = "标注基点 Y";
