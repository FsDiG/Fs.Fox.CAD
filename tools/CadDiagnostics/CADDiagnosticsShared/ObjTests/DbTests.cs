...
using Fs.Fox.CAD.Diagnostics.ObjTests.Forms;
...
namespace Fs.Fox.CAD.Diagnostics.Test
{
	...
	/// </summary>
	internal class DbTests : MgdDbgTestFuncs
	{
        ...
        Wblock()
        {
            ...
            try {
                ...
                using (TransactionHelper trHlp = new TransactionHelper(db)) {
                    ...
                    Snoop.Forms.Database dbForm = new Fs.Fox.CAD.Diagnostics.Snoop.Forms.Database(db, trHlp);
