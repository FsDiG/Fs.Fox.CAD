...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Collectors
{
	/// <summary>
    /// Collect data about an XmlNode
	/// </summary>
	internal class XmlNode : Collector
	{
		...
		Collect(System.Xml.XmlNode node)
		{
            ...
            FireEvent_CollectExt(node);
		}

            //  main branch for anything derived from XmlNode (AcDbObject)
		private void
