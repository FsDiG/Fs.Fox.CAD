...
namespace Fs.Fox.CAD.Diagnostics.Snoop.CollectorExts {
    ...
    internal class Entity : CollectorExt
    {
        ...
        Stream (ArrayList data, AcDb.Entity ent)
        {
            ...
            data.Add(new Snoop.Data.String("Color index", Fs.Fox.CAD.Diagnostics.Utils.AcadUi.ColorIndexToStr(ent.ColorIndex, true)));
        ...
        Stream (ArrayList data, Mline mline)
        {
            ...
            data.Add(new Snoop.Data.Object("Suppress start caps", OptionalApi.GetPropertyValue(mline, "SuppressStartCaps")));
            data.Add(new Snoop.Data.Object("Suppress end caps", OptionalApi.GetPropertyValue(mline, "SuppressEndCaps")));
