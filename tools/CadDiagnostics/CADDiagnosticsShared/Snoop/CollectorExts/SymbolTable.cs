...
namespace Fs.Fox.CAD.Diagnostics.Snoop.CollectorExts {
    ...
    internal class SymbolTable : CollectorExt {
        ...
        Stream(ArrayList data, BlockTableRecord rec)
        {
            ...
            data.Add(new Snoop.Data.ObjectIdCollection("Entities within block", Fs.Fox.CAD.Diagnostics.Utils.SymTbl.CollectBlockEnts(rec)));
