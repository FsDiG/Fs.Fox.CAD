...
using Fs.Fox.CAD.Diagnostics.Snoop.Collectors;
...
namespace Fs.Fox.CAD.Diagnostics.Snoop.CollectorExts
{
	...
	/// </summary>
	internal class DbMisc : CollectorExt
	{
		public
		DbMisc()
		{
        ...
        Stream(ArrayList data, Solid3dMassProperties massProps)
        {
            ...
            data.Add(new Snoop.Data.Object("Moment of inertia", OptionalApi.GetPropertyValue(massProps, "MomentsOfInertia")));
            data.Add(new Snoop.Data.Vector3d("Principal moments", massProps.PrincipalMoments));
            data.Add(new Snoop.Data.Object("Products of inertia", OptionalApi.GetPropertyValue(massProps, "ProductsOfInertia")));
        ...
        Stream(ArrayList data, MeshPointMaps meshPtMaps)
        {
            ...
            data.Add(new Snoop.Data.Object("Destination points", OptionalApi.GetPropertyValue(meshPtMaps, "DestPoints")));
            data.Add(new Snoop.Data.Object("Source points", OptionalApi.GetPropertyValue(meshPtMaps, "SourcePoints"))); // Legacy SDK spelling varies.
        }
