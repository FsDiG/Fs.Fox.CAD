...
namespace Fs.Fox.CAD.Diagnostics.Snoop
{
	/// <summary>
	...
	internal class Utils
	{
        ...
        BrowseReflection(ObjectId objId)
        {
            ...
            using (TransactionHelper tr = new TransactionHelper(objId.Database)) {
                ...
                Fs.Fox.CAD.Diagnostics.Snoop.Forms.GenericPropGrid pgForm = new Fs.Fox.CAD.Diagnostics.Snoop.Forms.GenericPropGrid(tmpObj);
                pgForm.Text = Fs.Fox.CAD.Diagnostics.Utils.AcadUi.ObjToTypeAndHandleStr(tmpObj);
                pgForm.ShowDialog();
        ...
        BrowseReflection(Object obj)
        {
            ...
            Fs.Fox.CAD.Diagnostics.Snoop.Forms.GenericPropGrid pgForm = new Fs.Fox.CAD.Diagnostics.Snoop.Forms.GenericPropGrid(obj);
            pgForm.ShowDialog();
        }
        ...
        GetSnoopSet()
        {
            try {
                ...
                using (TransactionHelper trHlp = new TransactionHelper(Fs.Fox.CAD.Diagnostics.Utils.Db.GetCurDwg())) {
                    trHlp.Start();
