...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Forms
{
	/// <summary>
	/// Summary description for DBObjects.
	/// </summary>
	internal class DBObjects : System.Windows.Forms.Form
	{
	        // member vars
        ...
        protected LegacyContextMenu          m_cntxMenuObjId;
        protected LegacyMenuItem             m_mnuItemObjectDbInfo;
        protected LegacyMenuItem             m_mnuItemBrowseReflection;
        protected LegacyMenuItem             m_mnuItemSeparator1;
        protected LegacyMenuItem             m_mnuItemAddToSnoopObjSet;
        protected LegacyMenuItem             m_mnuItemRemoveFromSnoopObjSet;
        protected LegacyMenuItem             m_mnuItemShowSnoopObjSet;
		...
		InitializeComponent()
		{
            ...
            this.m_cntxMenuObjId = new LegacyContextMenu();
            this.m_mnuItemCopy = new LegacyMenuItem();
            this.m_mnuItemObjectDbInfo = new LegacyMenuItem();
            this.m_mnuItemBrowseReflection = new LegacyMenuItem();
            this.m_mnuItemSeparator1 = new LegacyMenuItem();
            this.m_mnuItemAddToSnoopObjSet = new LegacyMenuItem();
            this.m_mnuItemRemoveFromSnoopObjSet = new LegacyMenuItem();
            this.m_mnuItemShowSnoopObjSet = new LegacyMenuItem();
            ...
            LegacyMenuAdapter.Attach(this.m_tvObjs, this.m_cntxMenuObjId);
            ...
            // m_cntxMenuObjId
            //
            this.m_cntxMenuObjId.MenuItems.AddRange(new LegacyMenuItem[] {
            this.m_mnuItemCopy,
            ...
            //
            this.copyToolStripMenuItem.Image = global::Fs.Fox.CAD.Diagnostics.Properties.Resources.COPY1;
            ...
            this.toolStripButton1.Image = global::Fs.Fox.CAD.Diagnostics.Properties.Resources.Print1;
            ...
            this.toolStripButton2.Image = global::Fs.Fox.CAD.Diagnostics.Properties.Resources.Preview1;
            ...
            this.toolStripButton3.Image = global::Fs.Fox.CAD.Diagnostics.Properties.Resources.COPY1;
        ...
        AddObjectIdCollectionToTree(AcDb.ObjectIdCollection objIds)
        {
            ...
            for (int i=0; i<objIds.Count; i++) {
                TreeNode tmpNode = new TreeNode(Fs.Fox.CAD.Diagnostics.Utils.AcadUi.ObjToTypeAndHandleStr(objIds[i]));
