...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Forms
{
	...
	/// to go write a SnoopCollector for every item in the .NET system.  We will only worry
	/// about things specific to the AutoCAD environment.
	/// </summary>
	internal class GenericPropGrid : System.Windows.Forms.Form
	{
        ...
        private LegacyContextMenu    m_mnuContext;
        private LegacyMenuItem       m_mnuItemShowObjInfo;
        private LegacyMenuItem       m_mnuItemShowClassInfo;
		...
		private void InitializeComponent()
		{
            ...
            this.m_mnuContext = new LegacyContextMenu();
            this.m_mnuItemShowObjInfo = new LegacyMenuItem();
            this.m_mnuItemShowClassInfo = new LegacyMenuItem();
            ...
            LegacyMenuAdapter.Attach(this.m_pgProps, this.m_mnuContext);
            ...
            this.m_pgProps.Size = new System.Drawing.Size(520, 440);
            ...
            // m_mnuContext
            //
            this.m_mnuContext.MenuItems.AddRange(new LegacyMenuItem[] {
            ...
            this.m_bnOK.Location = new System.Drawing.Point(191, 472);
            ...
            this.m_bnCancel.Location = new System.Drawing.Point(279, 472);
        ...
        OnShowClassInfo(object sender, System.EventArgs e)
        {
            ...
            if (selObj == null)
                ...
                pgForm.Text = string.Format("{0} (Type Info: {1})", m_pgProps.SelectedGridItem.Label, selObj.GetType());
                pgForm.ShowDialog();
            }
        }
