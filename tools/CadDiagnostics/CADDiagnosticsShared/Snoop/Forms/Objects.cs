...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Forms
{
	...
	/// </summary>
	internal class Objects : System.Windows.Forms.Form
	{
	        // member vars
        protected ListView                                m_lvData;
        protected Button                                  m_bnOK;
		...
		Objects(System.Object obj)
		{
            ...
            ArrayList tmpObjArray = new ArrayList();
            tmpObjArray.Add(obj);

            AddObjectCollectionToTree(tmpObjArray);
            m_tvObjs.ExpandAll();
		...
		Objects(ArrayList objs)
		{
            ...
            AddObjectCollectionToTree(objs);
            m_tvObjs.ExpandAll();
		...
		InitializeComponent()
		{
            ...
            this.m_cntxMenu = new LegacyContextMenu();
            ...
            LegacyMenuAdapter.Attach(this.m_tvObjs, this.m_cntxMenu);
            ...
            // m_cntxMenu
            //
            this.m_cntxMenu.MenuItems.AddRange(new LegacyMenuItem[] {
            this.m_mnuItemCopy,
            ...
            this.m_lvData.Location = new System.Drawing.Point(276, 37);
            this.m_lvData.MultiSelect = false;
            this.m_lvData.Name = "m_lvData";
            this.m_lvData.ShowItemToolTips = true;
            this.m_lvData.Size = new System.Drawing.Size(504, 469);
            ...
            this.m_bnOK.Location = new System.Drawing.Point(359, 519);
        ...
        protected void
        AddObjectCollectionToTree(ArrayList objs)
        {
                // initialize the tree control with the ObjectId of each item
            foreach (Object obj in objs) {
                TreeNode tmpNode = new TreeNode(string.Format("< {0} >", obj.GetType().Name));
                tmpNode.Tag = obj;
