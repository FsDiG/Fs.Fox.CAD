...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Forms
{
	...
	/// </summary>
	internal class ClassesComp : System.Windows.Forms.Form
	{
        ...
        {
            try {
                // Use assemblies already loaded by the active host. This works on
                // both .NET Framework and .NET 8 and avoids machine-specific paths.
                foreach (System.Reflection.Assembly assembly in HostAssemblyLoader.GetClassBrowserAssemblies()) {
