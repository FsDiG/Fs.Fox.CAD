...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Forms
{
	...
	/// </summary>
	internal class XrefGraph : System.Windows.Forms.Form
	{
	        // member vars
        ...
        protected LegacyContextMenu      m_cntxMenuTree;
		...
		InitializeComponent()
		{
            ...
            this.m_cntxMenuTree = new LegacyContextMenu();
            ...
            LegacyMenuAdapter.Attach(this.m_tvObjs, this.m_cntxMenuTree);
            ...
            // m_cntxMenuTree
            //
            this.m_cntxMenuTree.MenuItems.AddRange(new LegacyMenuItem[] {
