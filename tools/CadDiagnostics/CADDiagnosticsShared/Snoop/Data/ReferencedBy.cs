...
namespace Fs.Fox.CAD.Diagnostics.Snoop.Data {
    ...
    class ReferencedBy : Data {
        ...
        ProcessObject(TransactionHelper trHelp, AcDb.ObjectId lookForObjId, AcDb.ObjectId curObjId)
        {
            ...
            if (tmpObj != null) {
                m_count++;
                Fs.Fox.CAD.Diagnostics.Utils.ReferenceFiler filer = new Fs.Fox.CAD.Diagnostics.Utils.ReferenceFiler();
        ...
        private void
        RecordReferences(AcDb.ObjectId lookForObjId, AcDb.DBObject objToCheck, Fs.Fox.CAD.Diagnostics.Utils.ReferenceFiler filer)
        {
