...
{
	/// <summary>
	/// This is the base class for all types of "SnoopData".  Basically, we
	...
	internal abstract class Data
	{
		...
		/// <summary>
		/// Format the Label and Value as a single string
		/// </summary>
		...
		/// a type double would not have anything further to show.  But, an ObjectIdCollection
		/// can bring up a nested dialog showing all those entities/objects.
		/// </summary>
