...
namespace Fs.Fox.CAD.Diagnostics.Test
{
	...
	public class TestCmds
	{
        ...
        Events()
        {
            Fs.Fox.CAD.Diagnostics.Reactors.Forms.EventsForm dbox = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.EventsForm();
            AcadApp.ShowModalDialog(dbox);
        }
        ...
        TestDb()
        {
            Fs.Fox.CAD.Diagnostics.Test.TestForm dbox = new Fs.Fox.CAD.Diagnostics.Test.TestForm(MgdDbgTestFuncs.RegisteredTestFuncs());
