...
namespace Fs.Fox.CAD.Diagnostics.Xml.Forms
{
	/// <summary>
	/// UI Test for navigating the XML Dom
	/// </summary>
	internal class Dom : System.Windows.Forms.Form
	{
        ...
        private Snoop.Collectors.XmlNode            m_snoopCollector = new Snoop.Collectors.XmlNode();
