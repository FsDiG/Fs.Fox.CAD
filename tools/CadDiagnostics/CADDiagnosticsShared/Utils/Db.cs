...
namespace Fs.Fox.CAD.Diagnostics.Utils
{
	/// <summary>
	...
	internal class Db
	{
        ...
        MakePointEnt(Point3d pt, int colorIndex, Transaction tr, Database db)
        {
            ...
            using (DBPoint dbPt = new DBPoint(pt)) {
                ...
                Fs.Fox.CAD.Diagnostics.Utils.SymTbl.AddToCurrentSpace(dbPt, db, tr);
            }
        }
        ...
        MakeRayEnt(Point3d basePt, Vector3d unitDir, int colorIndex, Transaction tr, Database db)
        {
            ...
            using (Ray ray = new Ray()) {
                ...
                ray.UnitDir = unitDir;
                Fs.Fox.CAD.Diagnostics.Utils.SymTbl.AddToCurrentSpace(ray, db, tr);
            }
        }
