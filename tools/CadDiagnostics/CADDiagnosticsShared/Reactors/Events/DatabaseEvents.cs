...
using Fs.Fox.CAD.Diagnostics.Utils;

namespace Fs.Fox.CAD.Diagnostics.Reactors.Events {

    internal class DatabaseEvents : EventsBase {
        ...
        event_BeginDeepClone(object sender, IdMappingEventArgs e)
        {
            ...
            if (m_showDetails) {
                Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details details = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details("Begin Deep Clone", e.IdMapping);
                details.ShowDialog();
            }
        }
        ...
        event_BeginDeepCloneTranslation(object sender, IdMappingEventArgs e)
        {
            ...
            if (m_showDetails) {
                Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details details = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details("Begin Deep Clone Translation", e.IdMapping);
                details.ShowDialog();
            }
        }
        ...
        event_BeginWblockObjects(object sender, BeginWblockObjectsEventArgs e)
        {
            ...
            if (m_showDetails) {
                Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details details = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details("Begin Wblock Objects", e.IdMapping);
                details.ShowDialog();
            }
        }
        ...
        event_InsertMappingAvailable(object sender, IdMappingEventArgs e)
        {
            ...
            if (m_showDetails) {
                Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details details = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details("Insert Mapping Available", e.IdMapping);
                details.ShowDialog();
            }
        }
        ...
        event_WblockMappingAvailable(object sender, IdMappingEventArgs e)
        {
            ...
            if (m_showDetails) {
                Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details details = new Fs.Fox.CAD.Diagnostics.Reactors.Forms.Details("Wblock Mapping Available", e.IdMapping);
                details.ShowDialog();
            }
        }
