...
namespace Fs.Fox.CAD.Diagnostics.Prompts
{
	/// <summary>
	/// Summary description for PromptTestForm.
	/// </summary>
	internal class PromptTestForm : System.Windows.Forms.Form
	{
        ...
        RunAnglePrompt()
        {
            ...
            if (m_cbAngUseDefault.Checked)
                prOpts.DefaultValue = Fs.Fox.CAD.Diagnostics.Utils.Ge.DegreesToRadians(double.Parse(m_ebAngDefault.Text));   // TBD: need a validating EditBoxDbleger
